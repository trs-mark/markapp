function QuizHistoryDetailView(winParamObj) {
	...
	for (var h = 0; h < winParamObj.quiz_obj.quiz_list.length; h++) {
		...
		var tb_row1 = Ti.UI.createView({selectedBackgroundColor:'transparent',backgroundColor:'transparent',height:Ti.UI.SIZE,width:Ti.UI.FILL});
		...
		for (var i = 0; i < QuizObj.questions.length; i++) {
			var tb_row2 = Ti.UI.createView({selectedBackgroundColor:'transparent',backgroundColor:'transparent',height:Ti.UI.SIZE,width:Ti.UI.FILL});
			var sumTop = top;
			var no = i + 1;
